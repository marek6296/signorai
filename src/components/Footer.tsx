                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 pb-16">
                    ...
                    <div className="lg:col-span-5 space-y-4">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <a href="https://x.com/POSTOVINKY" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-border flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all duration-300">
                            ...
                            <a href="https://www.instagram.com/postovinky.news/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-border flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all duration-300">
