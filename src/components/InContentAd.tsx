...
export function InContentAd({ articles }: InContentAdProps) {
    ...
    return (
        <div className="my-8 p-[1px] bg-gradient-to-r from-primary/30 via-primary/5 to-transparent rounded-3xl overflow-hidden group shadow-lg">
            <div className="bg-card/80 backdrop-blur-xl border border-border/50 rounded-[1.45rem] p-4 md:p-6 relative overflow-hidden">
                {/* Decorative Background Icon */}
                <div className="absolute -right-8 -bottom-8 text-primary/10 group-hover:text-primary/20 transition-all duration-500 rotate-12">
                    <BookOpen size={160} />
                </div>

                <div className="relative z-10 flex flex-col md:flex-row gap-5 items-center">
                    {/* Image Thumbnail (Smaller) */}
                    <div className="relative w-full md:w-40 aspect-square md:aspect-square rounded-xl overflow-hidden border border-border shadow-xl shrink-0">
                        <Image
                    ...
                    <div className="flex flex-col flex-1 items-start text-left min-w-0">
                        <div className="flex items-center gap-2 mb-1.5">
                            ...
                            <span className="text-[9px] font-black uppercase tracking-[0.3em] text-primary">PREČÍTAJTE SI TIEŽ</span>
                        </div>
